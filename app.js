...
$climate.onclick=()=>{
    ...
    document.getElementById("frame").src=" https://www.theworldcounts.com/embed/challenges/23?";
...
$consumption.onclick=()=>{
    ...
    document.getElementById("frame").src="https://www.theworldcounts.com/embed/challenges/107?background_color=transparent&color=w[…]=%22Helvetica+Neue%22%2C+Arial%2C+sans-serif&font_size=20";
    document.body.style.backgroundSize = "100% 100%";
...
$people.onclick=()=>{
    ...
    document.getElementById("frame").src=" https://www.theworldcounts.com/embed/challenges/2?background_color=transparent&color=whi[…]=%22Helvetica+Neue%22%2C+Arial%2C+sans-serif&font_size=20";
    document.body.style.backgroundSize = "100% 100%";
